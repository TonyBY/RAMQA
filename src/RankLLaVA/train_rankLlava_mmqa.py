...
from src.RankLLaVA.data.reranking_dataset_class_mmqa import RankingDatasetMMQA
from src.RankLLaVA.data.collate_fn_mmqa import collate_fn_leftPad, collate_fn_rightPad
...
def train(args):
    ...
    train_dataset = RankingDatasetMMQA(
        data=train_dataset, 
        ...
        image_corpus_path=args.image_corpus_path,
        text_corpus_path=args.text_corpus_path,
        max_length=args.max_seq_len,
    )

    dev_dataset = RankingDatasetMMQA(
        data=dev_dataset,
        weighted_sampling=args.weighted_sampling,
        seed=args.seed,
        is_debug=args.debug, 
    ...
    training_arguments = TrainingArguments(
                                            ...
                                            lr_scheduler_type="cosine", # https://huggingface.co/docs/transformers/en/main_classes/optimizer_schedules#transformers.get_cosine_schedule_with_warmup
                                            warmup_steps=30,
